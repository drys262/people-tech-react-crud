...
export const LOAD_PEOPLE = 'peopletechtest/MainPage/LOAD_PEOPLE';
export const LOAD_PEOPLE_SUCCESS =
  'peopletechtest/MainPage/LOAD_PEOPLE_SUCCESS';
export const LOAD_PEOPLE_FAILED = 'peopletechtest/MainPage/LOAD_PEOPLE_FAILED';
export const UPDATE_SEARCH_TERM = 'peopletechtest/MainPage/UPDATE_SEARCH_TERM';
export const SELECT_DEV = 'peopletechtest/MainPage/SELECT_DEV';
